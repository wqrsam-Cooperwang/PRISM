...
def evaluate_governed_v22_shadow(
    ...
    snapshots = {item.prediction_id: item for item in load_formal_forward_testing_cohort(prediction_root)}
    ...
    for case in cases:
        ...
        shadow_root = _mapping(snapshot.payload.get("shadow_predictions"), "shadow_predictions")
