...
_REGIME_WEIGHTS: dict[ScorelineRegime, ScenarioWeights] = {
    ScorelineRegime.BALANCED_LOW: (
        ("balanced", 0.66),
        ("home_scores_first", 0.08),
        ("away_scores_first", 0.08),
        ("early_open", 0.08),
        ("symmetric_tail_floor", 0.10),
    ),
    ScorelineRegime.BALANCED_OPEN: (
        ("balanced", 0.42),
    ...
    ScorelineRegime.HOME_CONTROL: (
        ("balanced", 0.56),
        ("home_scores_first", 0.16),
        ("away_scores_first", 0.08),
        ("early_open", 0.10),
        ("symmetric_tail_floor", 0.10),
    ),
    ScorelineRegime.AWAY_CONTROL: (
        ("balanced", 0.56),
        ("home_scores_first", 0.08),
        ("away_scores_first", 0.16),
        ("early_open", 0.10),
        ("symmetric_tail_floor", 0.10),
    ),
    ScorelineRegime.HOME_OPEN: (
        ("balanced", 0.38),
        ("home_scores_first", 0.18),
        ("away_scores_first", 0.08),
        ("early_open", 0.28),
        ("symmetric_tail_floor", 0.08),
    ),
    ScorelineRegime.AWAY_OPEN: (
        ("balanced", 0.38),
        ("home_scores_first", 0.08),
        ("away_scores_first", 0.18),
        ("early_open", 0.28),
        ("symmetric_tail_floor", 0.08),
    ),
}
