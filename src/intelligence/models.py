...
class VerifiedClaim:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            ...
            tuple(
                _require_text(item, "observation_id") for item in self.supporting_observation_ids
            ),
        )
        object.__setattr__(
            self,
            ...
            tuple(
                _require_text(item, "observation_id") for item in self.conflicting_observation_ids
            ),
        )
        object.__setattr__(
            self,
